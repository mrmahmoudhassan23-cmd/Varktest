...
export default function TeacherPage() {
  ...
  const addClass = async () => {
    ...
    if (classes.some((c) => c.name === className)) {
      setError(`You already have a class named ${className}. Please delete it before creating another class with the same name.`); return;
    }
